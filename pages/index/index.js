    ...
    Page({
        data: {
         menuitems: [
            ...
            { text: '英译汉', hint: '在线英译汉', url: '../yingyihan/index', icon: '../../icons/yingyihan.png', tips: '', tap: '' },
            { text: '文案生成', hint: '生成热门标题、内容', url: '../wenan/index', icon: '../../icons/wenan.png', tips: '', tap: '' },
            { text: '生成故事', hint: '童话故事或任何其他类型故事', url: '../story/index', icon: '../../icons/story.png', tips: '', tap: '' },
            { text: '聊天机器人', hint: '问你想问的问题', url: '../chat/index', icon: '../../icons/chat.png', tips: '', tap: '' }
          ],
            // aa: [ {
            //     nickName: "智能生成工具，好玩的效率神器"
            // }, {
		...
		getNotice: function(){
			wx.request({
			    url: 'https://chat.cocogo.xyz/Api/getnotices',
				method: 'GET',
			    success: (result) => {
					console.log('获取公告成功！');
